    ...
    class SystemC < RegexLexer
      ...
      def self.keywords
        @keywords ||= Set.new %w(
          ...
          SC_REPORT_INFO SC_REPORT_ERROR SC_REPORT_WARNING SC_REPORT_INFO_VERB
      ...
      def self.name_class
        @name_class ||= Set.new %w(
          ...
          sc_event_finder sc_spawn_options sc_spawn
          sc_bind sc_ref sc_cref sc_logic
          sc_report_handler sc_buffer sc_clock
          sc_stage_callback_if sc_trace_file
      ...
      def self.name_function
        @name_function ||= Set.new %w(
          ...
          kind operator sensitive  sc_get_status stop_after
          get_child_objects get_child_events  get_parent_object get_process_object
          reset sync_reset_on sync_reset_off notify sc_hierarchical_name_exists
          sc_register_hierarchical_name sc_unregister_hierarchical_name
          suspend resume disable enable kill reset throw_it get_writer_policy
          ...
          posedge_event negedge_event value_changed_event
          ...
          throw name reset_event sc_is_unwinding valid size default_event
          ...
          to_signed to_unsigned get default_value q_mode
          ...
          cbegin cend sc_assemble_vector
          sc_abs sc_max sc_min
